...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonButtons, IonBackButton, IonGrid, IonRow, IonCol, IonLabel, IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonButton, IonIcon, IonSpinner } from '@ionic/angular/standalone';
...
@Component({
  selector: 'app-pagina-pago',
  templateUrl: './pagina-pago.page.html',
  styleUrls: ['./pagina-pago.page.scss'],
  standalone: true,
  imports: [IonSpinner, SharedModule, IonIcon, IonButton, IonCardContent, IonCardTitle, IonCardHeader, IonCard,
    IonLabel, IonCol, IonRow, IonGrid, IonBackButton, IonButtons, IonContent, IonHeader, IonTitle,
    IonToolbar, CommonModule, FormsModule, PaymentFormComponent, IonSpinner]
})
export class PaginaPagoPage implements OnInit {
